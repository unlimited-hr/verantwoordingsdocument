...
Belangrijke momenten die we hebben gehad en belangrijke informatie dat we hebben besproken zetten we standaard in ons logboek.
...
Deze beslissing kwam nadat niet iedereen het nut zag van zijn taken snel af krijgen, als er geen tijdsdruk op staat.
...
Vanwege de feedback dat het document onoverzichtelijk was, hebben we besloten om 'Docusaurus' te gebruiken in plaats van 'Word' om ons verslag in te typen.
In docusaurus is de styling altijd consistent, omdat het framework dit verzorgt. 
Daarnaast hebben we de keuze gemaakt om volgens de STARR methode te reflecteren dit zorgt voor een consistente structuur binnen het document.
...
Aan het einde van de dag vertelt iedereen even kort wat die gedaan heeft en werken Jira board bij. 
